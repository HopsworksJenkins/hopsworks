...
public class ProvElasticController {
  ...
  public GetIndexResponse mngIndexGet(GetIndexRequest request) throws ElasticException {
    ...
    try {
      ...
      ElasticException se = processException(e, msg);
      throw se;
    }
    return response;
  }
  ...
  private ElasticException processException(Exception e, String msg) {
...
//              ElasticException ex = new ElasticException(RESTCodes.ElasticErrorCode.ELASTIC_QUERY_NO_MAPPING,
...
//    }
    ...
    ElasticException ex = new ElasticException(RESTCodes.ElasticErrorCode.ELASTIC_INTERNAL_REQ_ERROR, Level.WARNING,
      msg, e.getMessage(), e);
    return ex;
  }
}
