...
public class ServiceDiscoveryController {
  ...
  @Lock(LockType.READ)
  public String constructServiceFQDN(SERVICE service) {
  ...
  @Lock(LockType.READ)
  public Service getAnyAddressOfServiceWithDNS(SERVICE serviceName) throws ServiceDiscoveryException {
    ...
    if (!serviceOpt.isPresent()) {
      throw new ServiceNotFoundException("Could not find service with: " + serviceQuery);
    }
